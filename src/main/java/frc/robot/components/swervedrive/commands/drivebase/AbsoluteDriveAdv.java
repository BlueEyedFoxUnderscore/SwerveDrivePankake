package frc.robot.components.swervedrive.commands.drivebase;
...
public class AbsoluteDriveAdv extends Command
{
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           _C.LOOP_TIME, _C.ROBOT_MASS, List.of(_C.CHASSIS),
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (_C.OperatorConstants.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else
    {
